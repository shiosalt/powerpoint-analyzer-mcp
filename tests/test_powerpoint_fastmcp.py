#!/usr/bin/env python3
"""
Test the PowerPoint FastMCP server using the same approach as the working simple test
"""
...
def test_powerpoint_fastmcp():
    """Test the PowerPoint FastMCP server."""
    print("Testing PowerPoint FastMCP Server")
    print("=" * 40)
...
if __name__ == "__main__":
    success = test_powerpoint_fastmcp()
    if success:
        print("\n🎉 PowerPoint FastMCP server is working!")
    else:
        print("\n❌ PowerPoint FastMCP server has issues")
